...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(cdlatex monokai-theme ox-hugo solarized-theme org-mobile-sync  wc-mode sdcv powerthesaurus all-the-icons)
