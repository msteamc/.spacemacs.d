...
#+header: :file  "~/Dropbox/mstemc_hugo/static/img/tikz/example.pdf"
#+begin_src latex
\begin{tikzpicture}
\draw (-1.5,0) -- (1.5,0);
\draw (0,-1.5) -- (0,1.5)
...
#+header: :fit yes :border 0cm :imoutoptions -geometry 900 -transparent white
#+begin_src latex :results raw :exports none
\begin{tikzpicture}
\filldraw [gray] (0,0) circle [radius=4pt]
                 (1,1) circle [radius=4pt]
                 (2,1) circle [radius=4pt]
                 (2,0) circle [radius=4pt];
\draw (0,0) .. controls (1,1) and (4,1) .. (2,0);
\end{tikzpicture}
#+end_src
...
#+header: :file  "~/Dropbox/mstemc_hugo/static/img/tikz/basiclayer.pdf"
#+header: :fit yes :border 0cm :imoutoptions -geometry 400 -transparent white
#+begin_src latex
...
#+RESULTS:
[[file:~/Dropbox/mstemc_hugo/static/img/tikz/basiclayer.pdf]]
