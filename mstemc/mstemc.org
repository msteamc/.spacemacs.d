...
** TODO test beamer
   ...
   :EXPORT_BEAMER_THEME: CambridgeUS
   :EXPORT_BEAMER_COLOR_THEME: default
   :EXPORT_BEAMER_FONT_THEME: default
   :EXPORT_BEAMER_INNER_THEME: default
   :EXPORT_BEAMER_OUTER_THEME: default
   :EXPORT_DESCRIPTION: summary of this project
   :END:
