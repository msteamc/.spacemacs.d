...
\author{Eason}
\date{\today}
\title{Set up the TikZ in Emacs Org Mode}
\hypersetup{
 pdfauthor={Eason},
 pdftitle={Set up the TikZ in Emacs Org Mode},
 pdfkeywords={},
 pdfsubject={},
...
\begin{description}
An introduction on how to setup the TikZ environment in Emacs Org Mode.So that
in Org file, you can generate either vector graph of \texttt{pdf} format or raster
graph of \texttt{png} format. Furthermore, you can export the vector graph when latex
is called and otherwise raster graph.
\end{description}

\section{config the header args}
\label{sec:orgd6868d4}
